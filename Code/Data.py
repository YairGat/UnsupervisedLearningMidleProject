...
class Data:
    ...
    def get_silhouette_list_kmean(self):
        ...
        for i in range(0, 5):
            silhoutte.append(self.silhouette(self.k_means, "K-MEANS", False, r[i]))
    ...
    def get_silhouette_list_gmm(self):
        ...
        r = np.random.choice(range(1, 100), 5, replace=False)
        for i in range(0, 4):
            silhoutte.append(self.silhouette(self.gmm, "GMM", False, r[i]))
        return np.transpose(silhoutte)
    ...
    def get_silhouette_list_hierarchical(self):
        ...
        r = np.random.choice(range(1, 100), 5, replace=False)
        for i in range(0, 4):
            silhoutte.append(self.silhouette(self.hierarchical, "hierarchical", False, r[i]))
        return np.transpose(silhoutte)
    ...
    def get_silhouette_list_fcm(self):
        ...
        r = np.random.choice(range(1, 100), 5, replace=False)
        for i in range(0, 4):
            silhoutte.append(self.silhouette(self.fcm, "FCM", False, r[i]))
        return np.transpose(silhoutte)
    ...
    def get_silhouette_list_spectral(self):
        ...
        r = np.random.choice(range(1, 100), 5, replace=False)
        for i in range(0, 4):
            silhoutte.append(self.silhouette(self.spectral, "Spectral", False, r[i]))
        return np.transpose(silhoutte)
